...
var svgmsg = "Generated by SVGo"

const (
	svgtop = `<?xml version="1.0"?>
<!-- %s -->
<svg `
	svginitfmt = `width="%d%s" height="%d%s"`
	svgns      = `
...
// Message sets the "generated by" message at the top of the document.
func (svg *SVG) Message(msg string) {
	svgmsg = msg
}
...
func (svg *SVG) Start(w int, h int, ns ...string) {
	svg.printf(svgtop+svginitfmt, svgmsg, w, "", h, "")
	svg.genattr(ns)
}
...
func (svg *SVG) Startunit(w int, h int, unit string, ns ...string) {
	svg.printf(svgtop+svginitfmt, svgmsg, w, unit, h, unit)
	svg.genattr(ns)
}
